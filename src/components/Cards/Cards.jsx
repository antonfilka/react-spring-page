...
const Cards = () => {
    ...
    const handleSearchStringChange = debounce(e => setSearchString(e.target.value), 300);

    const filteredCards = cards.filter(card => card.title.toLowerCase().includes(searchString) || card.text.toLowerCase().includes(searchString))
